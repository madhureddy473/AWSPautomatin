...
public class Listenersnew extends TestListenerAdapter{
	...
	private File createBlankExtentReport(){
		...
		try {
			generatedExtentReportFile = new File(new Listenersnew().returnUnifiedPathToLogs_Reports().concat("ExtentReport_" +dateName+".html"));
