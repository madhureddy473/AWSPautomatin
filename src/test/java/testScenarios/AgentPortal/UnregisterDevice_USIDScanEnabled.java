...
public class UnregisterDevice_USIDScanEnabled extends TestBase {
	
	@Test
	public void UnregisterDevice_USIDScanEnabled() throws Exception{
		...
		administrationPage.unRegisterDeviceWithNoEditButton(Unregister.get("mainOffice"), Unregister.get("locationId"));
	}
}
