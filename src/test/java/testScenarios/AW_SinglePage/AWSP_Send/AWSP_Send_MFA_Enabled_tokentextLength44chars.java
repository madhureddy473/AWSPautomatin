...
public class AWSP_Send_MFA_Enabled_tokentextLength44chars extends TestBase{
	@Test
	public void AWSP_Send_MFA_Enabled_tokentextLength44chars() throws Exception {
		...
		awsinglePage.destinationAndAmountexistReceiver(teller.get("amount"),teller.get("DestCountry"),teller.get("DestState"));
