...
public class AWSP_USNewPlusCusNewRcvr_HOME_DEL_NoID_High extends TestBase {

    @Test
    public void AWSP_USNewPlusCusNewRcvr_HOME_DEL_NoID_High() throws Exception {
        ...
        awsinglePage.serviceOption_homedelivery();
        ...
        awsinglePage.additionalInformation_homeDEL(teller.get("additionalInfoBirthCountry"),teller.get("senOccupation"),teller.get("ThirdpartyType"));
        //awsinglePage.receiverInformation(teller.get("rcvFirstName"),teller.get("rcvLastName"),teller.get("idIssueState"));
        awsinglePage.receiverInformation_HOmeDel(teller.get("rcvFirstName"),teller.get("rcvLastName"),teller.get("idIssueState"));
