...
public class AWSP_USNewPlusCusNewRcvr_HOME_DEL_NoID_Low extends TestBase {
	@Test
	public void AWSP_USNewPlusCusNewRcvr_HOME_DEL_NoID_Low() throws Exception {
		...
		awsinglePage.additionalInformation_homeDELlow(teller.get("additionalInfoBirthCountry"));
