...
public class AWSP_Send_Receivemoney_IndicativeCountry extends TestBase {

    @Test
    public void AWSP_Send_Receivemoney_IndicativeCountry() throws Exception {
...
awsinglePage.validationmesgforereceivecurrencies();
