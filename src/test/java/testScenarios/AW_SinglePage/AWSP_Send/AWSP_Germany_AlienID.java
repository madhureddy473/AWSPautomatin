...
public class AWSP_Germany_AlienID extends TestBase {

    @Test
    public void AWSP_Germany_AlienID() throws Exception {
        ...
        awsinglePage.additionalInformationlow(teller.get("additionalInfoBirthCountry"),teller.get("senOccupation"),teller.get("ThirdpartyType"));
