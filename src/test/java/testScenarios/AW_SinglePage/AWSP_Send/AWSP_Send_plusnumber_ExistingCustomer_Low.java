...
public class AWSP_Send_plusnumber_ExistingCustomer_Low extends TestBase {

    @Test
    public void AWSP_Send_plusnumber_ExistingCustomer_Low() throws Exception {
        ...
        awsinglePage.identificationforExistingonfilelow(teller.get("id1TypeonFile"),teller.get("id1onFile"), teller.get("id2TypeonFile"),teller.get("id2onFile"));
