...
public class AWSP_USA_LoyaltyEnrollment_HighAmounts extends TestBase {

    @Test
    public void AWSP_USA_LoyaltyEnrollment_HighAmounts() throws Exception {
        ...
        awsinglePage.verify20percentdiscountUSAHighamounts();
    }
}
