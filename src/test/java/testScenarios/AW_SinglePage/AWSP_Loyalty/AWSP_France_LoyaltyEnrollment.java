...
public class AWSP_France_LoyaltyEnrollment extends TestBase {

    @Test
    public void AWSP_France_LoyaltyEnrollment() throws Exception {
        ...
        awsinglePage.identificationforFRAnce(teller.get("idType"), teller.get("idNumber"),teller.get("idIssueCountry"),teller.get("idIssueState"),teller.get("expirationYear"),teller.get("expirationMonth"),teller.get("expirationDate"),teller.get("secIdType"),teller.get("secIdNumber"));
        awsinglePage.scanID();
       ...
       // awsinglePage.selectexistingIDtwo(teller.get("idChoice"), teller.get("secIdType"), teller.get("secIdNumber"));
        awsinglePage.additionalInformationfolowamontsfrance(teller.get("additionalInfoBirthCountry"), teller.get("citizenshipCountry"), teller.get("sourceOfFunds"), teller.get("purposeOfTransaction"));
