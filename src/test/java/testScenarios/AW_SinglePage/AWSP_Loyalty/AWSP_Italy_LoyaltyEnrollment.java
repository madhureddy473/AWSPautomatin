...
public class AWSP_Italy_LoyaltyEnrollment extends TestBase {

    @Test
    public void AWSP_Italy_LoyaltyEnrollment() throws Exception {
       ...
       // awsinglePage.selectexistingIDtwo(teller.get("idChoice"), teller.get("secIdType"), teller.get("secIdNumber"));
        ...
        awsinglePage.validationsforloyaltyIT(teller,teller.get("existingCustomer"));
