...
public class AWSP_Germany_LoyaltyEnrollment_40percent extends TestBase {

    @Test
    public void AWSP_Germany_LoyaltyEnrollment_40percent() throws Exception {
       ...
       // awsinglePage.selectexistingIDtwo(teller.get("idChoice"), teller.get("secIdType"), teller.get("secIdNumber"));
        ...
        awsinglePage.verify40percentdiscount();
