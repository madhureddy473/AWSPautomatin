...
import test.java.testScenarios.AgentWorks.Receive.USNewCusREC_NoID;
...
public class RecRev_NoID extends TestBase {
	@Test
	public void RecRev_NoID() throws Exception {
		DataDriven excelFile = new DataDriven();
		String className = this.getClass().getSimpleName();
		String filePath = Constants.File_Path;
		HashMap<String, String> teller = excelFile.readExcel(filePath,"AWDATA.xlsx","AmendCancel", className);
		HashMap<String, String> teller1 = excelFile.readExcel(filePath,"AWDATA.xlsx","Receive", "USNewCusREC_NoID");
