...
public class NewCustomer_ScanEnabled_Belgium_ID1 extends TestBase{
	@Test

	public void NewCustomer_ScanEnabled_Belgium_ID1() throws Exception {
		...
		write.setCellData(refNum, "NewCustomer_ScanEnabled_Receive_Belgium_ID1", "referenceNum");
		awhomePage.logout();
	}
}
