...
public class NewCustomer_ScanDisabled_Belgium_ID1_ID2 extends TestBase{
	@Test

	public void NewCustomer_ScanDisabled_Belgium_ID1_ID2() throws Exception {
		...
		write.setCellData(refNum, "NewCustomer_ScanDisabled_Receive_Greece_ID1_ID2", "referenceNum");
		awhomePage.logout();
	}
}
