...
public class ExistCustomer_ScanDisabled_Belgium_ID1 extends TestBase{
	@Test

	public void ExistCustomer_ScanDisabled_Belgium_ID1() throws Exception {
		...
		write.setCellData(refNum, "ExistCustomer_ScanDisabled_Receive_Belgium_ID1", "referenceNum");
