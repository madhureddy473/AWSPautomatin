...
public class NewCustomer_ScanEnabled_Belgium_ID1_ID2 extends TestBase{
	@Test

	public void NewCustomer_ScanEnabled_Belgium_ID1_ID2() throws Exception {
		...
		write.setCellData(refNum, "NewCustomer_ScanEnabled_Receive_Belgium_ID1_ID2", "referenceNum");
		awhomePage.logout();
	}
}
