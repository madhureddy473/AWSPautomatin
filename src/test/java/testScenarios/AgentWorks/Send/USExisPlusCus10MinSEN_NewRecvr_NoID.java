...
public class USExisPlusCus10MinSEN_NewRecvr_NoID extends TestBase {
	@Test
	public void USExisPlusCus10MinSEN_NewRecvr_NoID() throws Exception {
		...
		write1.setCellData(refNum, "USExisPlusCusREC_NoID", "referenceNum");
		awhomePage.logout();
