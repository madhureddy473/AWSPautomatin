...
public class New_Customer_Send_US_To_Italy_NoID extends TestBase{
	@Test

	public void New_Customer_Send_US_To_Italy_NoID() throws Exception {
		...
		write.setCellData(refNum, "USNewCus_Italy_REC_NoID", "referenceNum");
		...
		write.setCellData(refNum1, "FiscalCode_Receive_NegativeTest", "referenceNum");
		awhomePage.logout();
	}
}
