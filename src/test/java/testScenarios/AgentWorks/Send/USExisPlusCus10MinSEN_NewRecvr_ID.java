...
public class USExisPlusCus10MinSEN_NewRecvr_ID extends TestBase {
	@Test
	public void USExisPlusCus10MinSEN_NewRecvr_ID() throws Exception {
		...
		write1.setCellData(refNum, "USExisPlusCusREC_ID", "referenceNum");
		awhomePage.logout();
