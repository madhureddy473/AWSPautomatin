...
public class USNewPlusCusNewRcvr10Min_NoID extends TestBase {
	@Test
	public void USNewPlusCusNewRcvr10Min_NoID() throws Exception {
		...
		write.setCellData(refNum, "USNewPlusCusREC_NoID", "referenceNum");
		awhomePage.logout();
