...
public class USExisCus10MinSEN_NewRecvr_NoID extends TestBase {
	@Test
	public void USExisCus10MinSEN_NewRecvr_NoID() throws Exception {
		...
		write1.setCellData(refNum, "USExisCusREC_NoID", "referenceNum");
		awhomePage.logout();
