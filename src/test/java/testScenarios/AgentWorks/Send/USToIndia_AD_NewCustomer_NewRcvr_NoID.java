...
public class USToIndia_AD_NewCustomer_NewRcvr_NoID extends TestBase{
	@Test
	public void USToIndia_AD_NewCustomer_NewRcvr_NoID() throws Exception {
...
//		awsendPage.getNextBtn().click();
		...
		write.setCellData(refNum, "USToIndiaAD_NewCusRec_NoID", "referenceNum");
		awhomePage.logout();
	}
}
