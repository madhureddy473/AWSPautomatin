...
public class USNewCusNewRcvr10Min_ID extends TestBase{
	@Test

	public void USNewCusNewRcvr10Min_ID() throws Exception {
		...
		write.setCellData(refNum, "USNewCusREC_ID", "referenceNum");
		awhomePage.logout();
	}
}
