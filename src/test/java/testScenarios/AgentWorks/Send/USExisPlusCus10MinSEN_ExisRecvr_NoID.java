...
public class USExisPlusCus10MinSEN_ExisRecvr_NoID extends TestBase {
	@Test
	public void USExisPlusCus10MinSEN_ExisRecvr_NoID() throws Exception {
		...
		write1.setCellData(refNum, "Amend_a_Transaction_NoID", "referenceNum");
		awhomePage.logout();
