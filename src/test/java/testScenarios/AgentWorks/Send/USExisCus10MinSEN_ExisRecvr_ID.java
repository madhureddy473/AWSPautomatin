...
public class USExisCus10MinSEN_ExisRecvr_ID extends TestBase {
	@Test
	public void USExisCus10MinSEN_ExisRecvr_ID() throws Exception {
		...
		write1.setCellData(refNum, "Cancel_a_Transaction_ID", "referenceNum");
		awhomePage.logout();
