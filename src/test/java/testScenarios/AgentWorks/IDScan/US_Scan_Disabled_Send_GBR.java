...
public class US_Scan_Disabled_Send_GBR extends TestBase{
	@Test
	public void US_Scan_Disabled_Send_GBR() throws Exception {
		...
		write.setCellData(refNum, "UK_Scan_Disabled_Receive", "referenceNum");
		...
		write.setCellData(refNum1, "UK_Scan_Enabled_Receive", "referenceNum");
		awhomePage.logout();
	}
}
