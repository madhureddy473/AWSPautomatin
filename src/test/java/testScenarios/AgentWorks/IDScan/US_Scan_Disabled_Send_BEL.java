...
public class US_Scan_Disabled_Send_BEL extends TestBase{
	@Test
	public void US_Scan_Disabled_Send_BEL() throws Exception {
		...
		write.setCellData(refNum, "BE_ScanDisabled_PhotoCopy_Receive", "referenceNum");
		awhomePage.logout();
	}
}
