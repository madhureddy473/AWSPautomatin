...
public class MultiCurrency_ROUToUSA_USD_NewCusNewRcvr10Min_ID extends TestBase{
	@Test
	public void MultiCurrency_ROUToUSA_USD_NewCusNewRcvr10Min_ID() throws Exception {
...
//		awsendPage.fraudWarningPopup();
		...
		write.setCellData(refNum, "ROUToUSANewCusREC_USD_ID", "referenceNum");
		awhomePage.logout();
	}
}
