...
public class MultiCurrency_ROUToROU_RON_NewCusNewRcvr10Min_ID extends TestBase{
	@Test
	public void MultiCurrency_ROUToROU_RON_NewCusNewRcvr10Min_ID() throws Exception {
...
//		awsendPage.fraudWarningPopup();
		...
		write.setCellData(refNum, "ROUToROUNewCusRec_RON_ID", "referenceNum");
		awhomePage.logout();
	}
}
